...
import { EN_TERMS } from "@/lib/i18n/en"

export const metadata: Metadata = createMetadata({
  title: EN_TERMS.metaTitle,
  description: EN_TERMS.metaDescription,
  path: "/en/terms",
  locale: "en",
  altLocalePath: "/terms",
})
    ...
    <div className="min-h-screen">
      ...
      <main>
        <section className="px-5 sm:px-6 lg:px-8 pt-24 pb-16 sm:pt-28 max-w-3xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">{EN_TERMS.heroTitle}</h1>
          <p className="text-gray-600 text-sm sm:text-base mb-8">{EN_TERMS.heroSubtitle}</p>
          <div className="space-y-8">
            {EN_TERMS.sections.map((section) => (

...
export class Sheet {
  constructor(name, rowCount=10, columnCount=52){this.name=name;this.maxRows=rowCount;this.maxColumns=columnCount;this.cells=Array.from({length:rowCount},()=>Array(columnCount).fill(''));}

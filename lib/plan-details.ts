...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  C2: {
    ...
    included: ["シュノーケル器材一式", "ライフジャケット", "浮き輪", "ウェットスーツ", "度付きメガネ", "懐中電灯", "写真・動画データ（枚数無制限）", "保険", "安全講習", "専属ガイド"],
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル（推奨）", "歩きやすい靴（夜用）", "虫よけスプレー"],
    precautions: [
      "海況・天候により、ウミガメシュノーケルまたはヤシガニ探検の開催時間・開催場所が変更になる場合があります。",
      "ウミガメは野生生物のため、遭遇を保証するものではありません。",
  ...
  C6: {
    ...
    included: ["シュノーケル器材一式", "ライフジャケット", "浮き輪", "SUPボード一式", "ウェットスーツ", "度付きメガネ", "懐中電灯", "写真・動画データ（枚数無制限）", "ドローン撮影データ", "保険", "安全講習", "専属ガイド"],
    whatToBring: ["着替え", "タオル", "日焼け止め", "飲み物", "サンダル（推奨）", "歩きやすい靴（夜用）", "虫よけスプレー"],
    precautions: [
      "1日に3つのツアーを行うため、体力に余裕を持ってご参加ください。",
      "海況・水位・天候により、各ツアーの開催時間・開催場所が変更になる場合があります。",

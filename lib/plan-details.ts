import { NIGHT_TOUR_PUBLIC_LOCATION } from "@/lib/meeting-guidance"
...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  S3: {
    ...
    highlights: [
      {
        "title": "0歳から参加OK",
        "description": "3歳以下は無料！お子様の夏の自由研究にもぴったりです。60歳以上の方を含むグループは【貸切】本格ナイトツアーをご予約ください。",
        "icon": "baby"
      },
      {
        "title": "巨大ヤシガニに遭遇",
        "description": "絶滅危惧種に指定されている巨大なヤシガニに遭遇できるかも！他にも夜にしか見られない珍しい植物や生き物たちがたくさん。",
        "icon": "bug"
      },
      {
        "title": "夜行性の生き物たち",
        "description": "ヤシガニのほか、オカヤドカリや珍しい夜の生き物に出会えるかも。昼間は見られない宮古島の夜の住人を観察できます。",
        "icon": "bug"
      },
      {
        "title": "本格派ガイド",
        "description": "アマゾン帰りの経験豊富なガイドが、その日一番生き物に出会えそうなポイントへご案内。ワクワクの解説付き！",
        "icon": "compass"
      }
    ],
    flow: [
      {
        "step": 1,
        "title": "集合・受付",
        "description": "開催場所にて現地集合。ガイドがお出迎えし、注意事項や生き物を探すコツを説明します。",
        "time": "19:20 / 21:10 / 23:20"
      },
      {
        "step": 2,
        "title": "探検準備",
        "description": "専用の懐中電灯などをお貸出し。ワクワクの夜のジャングルへ出発準備！"
      },
      {
        "step": 3,
        "title": "ナイトサファリ",
        "description": "絶滅危惧種の巨大ヤシガニなどの生き物を探しながら夜の亜熱帯を探検！",
        "time": "約1.5時間"
      },
      {
        "step": 4,
        "title": "お会計・解散",
        "description": "お会計後、解散。探検中の写真データも無料でお渡しします。"
      }
    ],
    included: [
      "懐中電灯",
    ...
    whatToBring: [
      "歩きやすい靴（サンダルでも参加可能ですが、歩きやすい靴をおすすめします）",
      "虫よけスプレー",
      "飲み物",
      "懐中電灯（貸出あり）"
    ],
    precautions: [
      ...
      "23:20便は翌日0:50頃の解散予定です"
    ],
    location: NIGHT_TOUR_PUBLIC_LOCATION,
    meetingTime: "開始時間と同じ（19:20 / 21:10 / 23:20）",
    paymentMethod: "ツアー当日・現地での現金決済（できるだけお釣りが出ないようご協力ください）",
    faqs: [
      {
        "q": "赤ちゃん連れでも大丈夫ですか？",
        "a": "はい！0歳から参加OK、3歳以下は無料です。抱っこ紐やベビーカーでのご参加も問題ありません。"
      },
      {
        "q": "虫が苦手でも楽しめますか？",
        "a": "虫を触る必要はありませんのでご安心ください。観察を楽しむスタイルです。虫よけスプレーを持参いただくと快適です。"
      },
      {
        "q": "どんな生き物に会えますか？",
        "a": "巨大ヤシガニ、オカヤドカリ、ナイトバタフライ、夜行性のトカゲなど、宮古島ならではの生き物に出会えます。季節によって会える生き物が変わるのも魅力です。"
      },
      {
        "q": "開催場所はどこですか？",
        "a": "当日の天候や気温で生き物の出やすい場所が変わるため、集合場所は当日にLINEでご案内します。その日いちばん生き物に会えそうなポイントをガイドが選定します（海のツアーは前日のご案内です）。"
      }
    ],
  },
  S4: {
  ...
  S5: {
    ...
    highlights: [
      {
        "title": "完全貸切・専属ガイド",
        "description": "お客様のグループだけの完全プライベートツアー。他のお客様を気にせず、立ち止まったり写真を撮ったり自由に探検できます。",
        "icon": "crown"
      },
      {
        "title": "じっくり解説付き",
        "description": "通常プランでは伝えきれない生き物の生態や宮古島の自然について、専属ガイドがお客様の興味に合わせてたっぷり解説。お子様の「なぜ？」にもじっくりお答え。",
        "icon": "compass"
      },
      {
        "title": "0歳から参加OK",
        "description": "赤ちゃんからおじいちゃんおばあちゃんまで、三世代でのご参加も大歓迎。3歳以下は無料！貸切だからペースも自由自在。",
        "icon": "baby"
      },
      {
        "title": "巨大ヤシガニに遭遇",
        "description": "絶滅危惧種の巨大ヤシガニや夜行性の生き物を専属ガイドが徹底的に探します。貸切ならではのじっくり観察体験。",
        "icon": "bug"
      }
    ],
    flow: [
      {
        "step": 1,
        "title": "集合・受付",
        "description": "開催場所にて現地集合。専属ガイドがお出迎えし、注意事項や生き物を探すコツを説明します。",
        "time": "19:20 / 21:10 / 23:20"
      },
      {
        "step": 2,
        "title": "探検準備",
        "description": "専用の懐中電灯などをお貸出し。お客様のペースで出発準備。"
      },
      {
        "step": 3,
        "title": "貸切ナイトサファリ",
        "description": "お客様だけのプライベート探検！気になる生き物を見つけたら、立ち止まってじっくり観察＆撮影。",
        "time": "約1.5時間"
      },
      {
        "step": 4,
    ...
    faqs: [
      {
        "q": "通常ナイトツアーとの違いは？",
        "a": "完全貸切なのでお客様のペースで探検できます。専属ガイドがじっくり解説するので、通常プランより深い体験ができます。小さなお子様連れやご年配の方がいるグループに特におすすめです。"
      },
      {
        "q": "何名まで参加できますか？",
        "a": "人数制限は特にありません。大人数の場合はLINEでご相談ください。"
      },
      {
        "q": "通常プランとどちらがおすすめ？",
        "a": "60歳以上の方を含むグループは本貸切プランのご予約が必要です。60歳未満の方のみのグループでは、気軽に楽しむなら通常プラン、じっくり楽しむなら貸切プランをお選びいただけます。"
      }
    ],
  },
  C1: {

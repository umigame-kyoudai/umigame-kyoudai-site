...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  C1: {
    ...
    tagline: "昼はウミガメ、夜はヤシガニ探検。海と夜のジャングルを1日で楽しむ満喫セット",
    heroDescription: "昼は宮古島の海でウミガメシュノーケル、夜はヤシガニや夜行性の生き物を探すジャングルナイトツアーへ。海と夜の自然を1日で楽しめる、宮古島満喫セットプラン。通常より1,000円お得です。",
    ...
    flow: [
      ...
      { step: 4, title: "【夜】ジャングルナイトツアー", description: "夜の亜熱帯ジャングルを探検。巨大ヤシガニや夜行性の生き物を探します。終了後にお会計・解散。", time: "約1.5時間" },
    ],

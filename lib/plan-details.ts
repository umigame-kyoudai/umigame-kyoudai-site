...
export const PLAN_DETAILS: Record<string, PlanDetail> = {
  ...
  S6: {
    ...
    highlights: [
      ...
      { title: "海況・水位に合わせて案内", description: "安全に綺麗な写真を撮れる時間を優先するため、開始時間は当日の海況・水位により調整する場合があります。", icon: "shield" },
    ],
    flow: [
      { step: 1, title: "集合・受付", description: "当日の海況・水位を見て、ガイドより集合場所と開始時間をご案内します。", time: "予約確定時にご案内" },
    ...
    meetingTime: "当日の海況・水位により調整（予約確定時にご案内）",
    paymentMethod: "現地現金決済（できるだけお釣りが出ないようご協力ください）",
    faqs: [
      { q: "開始時間は何時ですか？", a: "当日の海況・水位によって最適な時間が変わるため、予約確定時にLINEでご案内します。安全に楽しめて、写真が綺麗に残りやすい時間帯を優先します。" },
  ...
  C2: {
    ...
    faqs: [
      ...
      { q: "何名まで参加できますか？", a: "目安は最大6名までです。7名以上の場合はLINEでご相談ください。" },
